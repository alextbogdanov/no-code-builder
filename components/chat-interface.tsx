...
import { Send, Sparkles, User, Bot, Wand2, Palette, Rocket, RefreshCw, Code2, ChevronDown, ChevronUp } from 'lucide-react';
...
function LoadingIndicator({ stage }: { stage: 'analyzing' | 'designing' | 'recovering' | 'deploying' }) {
              ...
              >
                <p
                  className={`
                    ...
                    ${message.role === 'user' ? 'text-white' : 'text-midnight-200'}
                  `}
                >
                  {message.content}
                </p>
