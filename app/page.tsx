...
import { Sparkles, ArrowRight, Zap, Globe, Code2, Wand2 } from 'lucide-react';
...
export default function LandingPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const projectName = prompt.slice(0, 50).replace(/[^a-zA-Z0-9\s]/g, '') || 'My Project';
  ...
  return (
    <main className="min-h-screen bg-midnight-950 overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-0 right-1/4 w-[600px] h-[600px] bg-aurora-cyan/10 rounded-full blur-[100px] animate-pulse-slow" style={{ animationDelay: '-2s' }} />
      ...
      <section className="relative z-10 py-20 px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { step: '01', title: 'Describe', text: 'Tell us what you want to build in plain English' },
              { step: '02', title: 'Generate', text: 'AI creates your project with beautiful code' },
              { step: '03', title: 'Deploy', text: 'Get a live URL instantly, iterate and improve' },
            ].map((item, index) => (
              <motion.div
                key={item.step}
                initial={{ opacity: 0, y: 20 }}
